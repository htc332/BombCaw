...
echo ""
echo "Step 2: 使用分包配置构建..."
# 关键配置：
# - mainBundleIsRemote=true: 主包资源远程加载
# - assetsRemoteType=DOWNLOAD: 资源下载方式
# - buildSubPackage=true: 构建分包
"$COCOS" \
  --project "$PROJECT_PATH" \
  --build "platform=wechatgame;debug=false;md5Cache=true;mainBundleIsRemote=true;assetsRemoteType=DOWNLOAD;buildSubPackage=true;remoteServerAddress=;previewWidth=720;previewHeight=1280;useDebugKey=true;wechatGameAppId=wx6ac3f5090a6b99c5" \
  2>&1 | tail -30
