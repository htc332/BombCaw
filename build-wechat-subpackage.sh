...
"$COCOS" \
  ...
  --build "platform=wechatgame;debug=false;md5Cache=true;mainBundleIsRemote=true;assetsRemoteType=DOWNLOAD;buildSubPackage=true;wechatGameAppId=wx6ac3f5090a6b99c5" \
  2>&1 | tail -30
